...
<html lang="en">
            ...
            <div class="akDisplayContainerOuter">
                <div class="akDisplayContainer" id="displayContainer">
                    ...
                    <div class="akBackBoard">
                        ...
                        <div class="inputItem">
                            <label for="num"> Assignment 1 Score: </label>
                            <input type="number" id="assignment1Score" name="num" placeholder="52" required>
                        </div>
    ...
    <!-- js scripts -->
    <script src="scripts/assignmentPredictMach1.js"></script>
